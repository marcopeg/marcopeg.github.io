...
> In _Real Life_ queues form when the amount of work to do **grows faster** than the processing capabilities.
> 
...
queing a new task is as fast as creating the user's record in the `accounts` table.
...
Back then I was working with an incredible smart guy, but he was very green and I didn't feel like throwing at him
...
Another tricky requirement was that different **tasks should run at different speed**. Some should run once a day,
...
We were (naively) aiming to _only_ a few millions influencers... It should be enough, right?
...
It's been a long uphill road working with indexes, data partitioning, smart constrains, triggers and notifications.
